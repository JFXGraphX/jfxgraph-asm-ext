 ...
 * @author Chris Beams
 * @author Albert
 * @since 4.0 2013年10月25日 上午11:34:55
...
public interface MethodMetadata {
    ...
    /**
     * Return whether the underlying method is overridable, i.e. not marked as
     ...
     * if defined on the underlying method, as direct annotation or as
     * meta-annotation).
     * 
     * @param annotationType
     *            the annotation type to look for
