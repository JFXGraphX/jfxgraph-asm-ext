 ...
 * 
 * @author Albert
 * @since 4.0 2013年10月25日 上午11:34:13
 */
public interface AnnotationMetadata extends ClassMetadata {
    ...
    /**
     * Return the names of all meta-annotation types defined on the given
     * annotation type of the underlying class.
     * 
     ...
     * <p>
     * This is equivalent to a "hasAnnotation || hasMetaAnnotation" check. If
     * this method returns {@code true}, then {@link #getAnnotationAttributes}
     ...
     * if defined on the underlying class, as direct annotation or as
     * meta-annotation).
     * 
     * @param annotationType
     *            the annotation type to look for
     * @return a Map of attributes, with the attribute name as key (e.g.
     *         "value") and the defined attribute value as Map value. This
     *         return value will be {@code null} if no matching annotation is
     *         defined.
     */
     ...
     *            whether to convert class references to String class names for
     *            exposure as values in the returned Map, instead of Class
    ...
    /**
     * Determine whether the underlying class has any methods that are annotated
     ...
     *         annotation. The return value will be an empty set if no methods
